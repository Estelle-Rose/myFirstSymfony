...
class Personnage {
    ...
    public static function createPlayer() {
        ...
        À la fois atterré et furieux, Ortiz rejoignit les Assassins à qui il offrit non seulement sa force, mais aussi son talent de forgeron, et il fabriqua pour eux des armes qui vengeraient son ami.",['force'=>5,'discretion'=>2,'agilite'=>2, 'arme' => 'marteau']);
        ...
        Par la suite, Shao Jun retourna en Chine pour affronter les Huit Tigres et reconstituer la Confrérie locale, dont elle devint le Mentor.",['force'=>4,'discretion'=>2,'agilite'=>4, 'arme' => 'épée longue']);
    }
